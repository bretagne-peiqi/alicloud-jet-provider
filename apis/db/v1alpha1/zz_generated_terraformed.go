...
func (tr *Mysql) GetObservation() (map[string]interface{}, error) {
...
func (tr *Mysql) SetObservation(obs map[string]interface{}) error {
...
func (tr *Mysql) GetParameters() (map[string]interface{}, error) {
...
func (tr *Mysql) SetParameters(params map[string]interface{}) error {
